...
class BluetoothDevice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BluetoothDevice', createEmptyInstance: create)
    ...
    ..e<BluetoothDevice_MajorClass>(4, 'majorClass', $pb.PbFieldType.OE, protoName: 'majorClass', defaultOrMaker: BluetoothDevice_MajorClass.AUDIO_VIDEO, valueOf: BluetoothDevice_MajorClass.valueOf, enumValues: BluetoothDevice_MajorClass.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  BluetoothDevice_MajorClass get majorClass => $_getN(3);
  @$pb.TagNumber(4)
  set majorClass(BluetoothDevice_MajorClass v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMajorClass() => $_has(3);
  @$pb.TagNumber(4)
  void clearMajorClass() => clearField(4);
}
